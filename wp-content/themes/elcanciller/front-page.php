...
<section id="primary" class="content-area">
	<main id="main" class="site-main">
		...
		<div class="outer-container">
			<div class="ad-970">
			<?php echo get_the_field('anuncio_2', $page_id) ?>
			</div>
			<?php get_template_part('template-parts/sections/section', 'placas') ?>
			<div class="ad-970"><?php echo get_the_field('anuncio_3', $page_id) ?></div>
			<?php get_template_part('template-parts/sections/section', 'instagram') ?>
			<div class="ad-970"><?php echo get_the_field('anuncio_4', $page_id) ?></div>
			<?php get_template_part('template-parts/sections/section', 'videos') ?>
			<div class="ad-970"><?php echo get_the_field('anuncio_5', $page_id) ?></div>
			<div class="loader">Cargando...</div>
